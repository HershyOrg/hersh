...
func TestWatchTick_BasicFunctionality(t *testing.T) {
	...
	watcher.Manage(func(msg *shared.Message, runCtx shared.HershContext) error {
		tick := hutil.WatchTick("test_ticker", 100*time.Millisecond, runCtx)
...
func TestWatchTick_ImmediateInitialTick(t *testing.T) {
	...
	watcher.Manage(func(msg *shared.Message, runCtx shared.HershContext) error {
		tick := hutil.WatchTick("immediate_ticker", 500*time.Millisecond, runCtx)
...
func TestWatchTick_TickCountIncrement(t *testing.T) {
	...
	watcher.Manage(func(msg *shared.Message, runCtx shared.HershContext) error {
		tick := hutil.WatchTick("count_ticker", 150*time.Millisecond, runCtx)
