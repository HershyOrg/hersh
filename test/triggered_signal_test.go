...
func TestTriggeredSignal_WatchCall(t *testing.T) {
	...
	watcher.Manage(func(msg *shared.Message, runCtx shared.ManageContext) error {
		...
		hersh.DELELTED_WatchCall[int](0, func() (wm.DELETED_VarUpdateFunc[int], bool, error) {
...
func TestTriggeredSignal_Mixed(t *testing.T) {
	...
	watcher.Manage(func(msg *shared.Message, runCtx shared.ManageContext) error {
		...
		// 3. WatchCall: 카운터
		counterHV := hersh.DELELTED_WatchCall[int](0, func() (wm.DELETED_VarUpdateFunc[int], bool, error) {
			return func(prev int) (int, error) {
				return prev + 1, nil
			}, false, nil
